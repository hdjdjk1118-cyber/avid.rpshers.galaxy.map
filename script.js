...
window.addEventListener("user-ready", function() {
  ...
  setTimeout(async () => {
    ...
    const sectors = [
      ...
      { name: "Rictus", color: "#9b59b6",coords: [[1417, 1844],[1034, 1741],[1017, 1814],[1005, 1888],[1000, 1965],[1002, 2082],[1014, 2181],[1045, 2303],[1085, 2411],[1132, 2501][1302, 2403],[1260, 2317],[1229, 2231],[1224, 2209],[1415, 2157],[1401, 2093],[1395, 2020],[1398, 1947],[1406, 1893]
  ]
}
    ];
    sectors.forEach(s => {
